...
You can install the **theseusplot** package from this repository in editable mode.

```bash
python -m pip install -e .
```

You can install the optional dependencies for examples and documentation data with:
